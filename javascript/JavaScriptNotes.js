...
// Compare two arrays
const arrayIsSame = (a, b) => a.length === b.length && a.every((v, i) => v === b[i]);

// Compare two arrays regardless of order
const arrayIsEqual = (a, b) => JSON.stringify([...new Set(a)].sort()) === JSON.stringify([...new Set(b)].sort());

// Remove duplicate values from an array.
const arrayDelDup = (arr) => [... new Set(arr)];

// Shuffle an array.
const shuffle = (arr) => arr.sort(() => 0.5 - Math.random())

// ISSET
const isset = (vari) => (typeof vari !== 'undefined');